#
#  Be sure to run `pod spec lint ComplicatedViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.social_media_url   = "http://twitter.com/yilia.zhang"
  ...
  s.source_files  = "Demo/ComplicatedViewController/*.{h,swift}"
